...
INSERT INTO "new_Observe" ("createdAtMS", "cssSelector", "currentText", "domElementProperty", "lastScrapeAtMS", "name", "scrapeIntervalType", "updatedAtMS", "url", "userId") SELECT "createdAtMS", "cssSelector", "currentText", "domElementProperty", "lastScrapeAtMS", "name", "scrapeIntervalType", "updatedAtMS", "url", "userId" FROM "Observe";
DROP TABLE "Observe";
