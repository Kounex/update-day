...
INSERT INTO "new_Observe" ("active", "consecutiveTimeouts", "createdAtMS", "cssSelector", "currentText", "domElementProperty", "guildId", "keepActive", "lastScrapeAtMS", "name", "scrapeIntervalType", "updatedAtMS", "url", "userId") SELECT "active", "consecutiveTimeouts", "createdAtMS", "cssSelector", "currentText", "domElementProperty", "guildId", "keepActive", "lastScrapeAtMS", "name", "scrapeIntervalType", "updatedAtMS", "url", "userId" FROM "Observe";
DROP TABLE "Observe";
